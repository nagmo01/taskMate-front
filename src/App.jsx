...
function App() {
      ...
      <div key={todo.id}>
        <div className='mx-2 my-2 flex justify-between'>
          ...
          <div className='mr-3 flex items-center'>
            <button className='rounded-full bg-white hover:bg-black p-2 text-black hover:text-white border border-black mr-1' onClick={() => onEdit(todo.id)}>
  ...
  return (
    <div className='max-w-sm bg-white mx-auto rounded-md shadow-lg mt-10'>
      ...
      <div className='text-2xl container mx-auto pb-2'>
          {list}
      </div>
