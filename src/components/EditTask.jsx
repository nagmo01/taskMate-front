    ...
    <div className="pt-3">
      {isInputClick ? (
        ...
        >
          <input
            ...
            autoFocus
            onBlur={handleBlur}
            className="ps-3 py-3 w-full font-sans font-bold"
          />
        </form>
      ) : (
        <div
          className="ps-3 py-3 w-full font-sans font-bold outline-black"
      ...
      {isBodyClick ? (
        ...
        <div
          ...
          className="w-full text-left text-lg px-3 mt-7 mb-10 whitespace-pre-wrap outline-black"
          style={{ height: '500px' }} 
        >
          {task.body}
        </div>
